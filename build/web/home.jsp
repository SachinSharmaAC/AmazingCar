...
<a class="navbar-brand" href="#" style="color:#FF0000">Amazing Car</a>
...
<!--HOME PAGE-->  
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
	        ...
	        <div class="item" >
        <img src="images/a.jpg" alt="Chicago" style="width:100%; height:10;">
        ...
        <img src="images/b.jpg" id="imgslid" alt="Los Angeles" style="width:100%;">
        <div class="carousel-caption">
          <h5>Welcome</h5>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <h5>Get more details of Amazing_car.com </h5>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <h5>Thanks For a Visit Amazing-Car.com</h5>
        </div>
      </div>
        ...
        <div class="carousel-caption">
          <h5>Get more details of Amazing-Car.com </h5>
        </div>
      </div>
...
<div class="row" >
   ...
   <center> 
    <div class="col-sm-10">
<h2>Welcome to The World Most Amazing Car </h2>
<p> 
    
    <br>
        Amazing Car India is published as a monthly magazine and currently enjoys the highest readership among automobile magazines in India (IRS-2009 R1 report). A television show titled 'The Amazing Car Show' also airs weekly on Times Now and ET Now which enjoys the highest viewership among Indian automobile programmes (source). Amazing Car India has a strong digital presence with the website providing a daily feed of automobile news, updates and reviews. The Amazing Car India YouTube channel features numerous videos with reviews, comparisons and other exciting automotive content. Amazing Car India's digital presence extends to Twitter, Facebook, Instagram and Google+.


Led by Mr.Sachin and his Team, India's leading automobile journalist, the first Amazing Car India issue came out in september2017. Over the years, the brand has earned an enviable reputation for high level of editorial content, production standards and meticulous testing. The parent brand, 'Autocar', was first published in 2000 and is referred to as the world's oldest car magazine. Autocar also lays claim to inventing the road test in 1998.
</h2></div>
       </center>
...
<div class="container-fluid footer" style="background-color:orange;">
<div class="container-fluid">
<div class="col-sm-4">
...
<p>Address : </strong> Sachin,(Delhi)</p>
<p>Email : </strong> amazing_car@gmail.com</p>
<p>Phone : </strong>9999999999</p>
