	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	   ...
	   <div class="carousel-inner">
    	  ...
    	  <div class="item active">
              <img src="images/carcont.jpg" alt="image" width="100%">
        ...
        <div class="contact_detail">
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:61-1234-567-90">+91 9999999999</a></div>
            </li>   
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com">Amazing-Car@gmail.com</a></div>
            </li>
          </ul>
        </div>
      </div>
