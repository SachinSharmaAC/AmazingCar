            ...
            <c:forEach var="a" items="${value}" >
                ...
                <div class="column">
                    <div class="card" style="background-color: white">
                        <img src="${a.getCarimage()}" width="360px" height="340px"/> 
                        <div class="container">
                            <h5><b style="color:#000">${a.getCarname()}</b></h5>
                            <p class="title">Author By Sachin</p> 
                            <p style="background-color: gray; width:330px; padding: 10px"><b  style="color: red"> Rs./- </b><b style="color: black">${a.getCarprice()}</b> <input style="margin-left: 60px" class ="btn btn-danger" data-toggle="modal" data-target="#myModal" type="button" value="Book Now"></p>
                        </div>
                    </div>
                </div>
            </c:forEach>
...
</div> <!--latest footer at bottom ending -->
        <!--footer section end -->
