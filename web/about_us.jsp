...
<a class="navbar-brand" href="#" style="color:#FF0000">Amazing Car</a>
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="about_us.jsp" style="background-color: orange">About Us</a></li>
...
<div  style="background-color:orange;" class="abs-back"></div>
<div class="wel">
<div class="wel-info">
<h1>Know About Us</h1>
<span class="brk"></span>
<h3>Welcome to Amazing_car.com - India's largest auto media vehicle. Amazing_car.com has always striven to serve car buyers and owners in the most comprehensive and convenient way possible. We provide a platform where car buyers and owners can research, buy, sell and come together to discuss and talk about their cars. 
...
<div class="row">
  ...
  <div  style="background-color:blueviolet;"class="col-sm-12 col-md-12 text-center">
      <br>
      <br>
      <br>
      <br>
    <div class="thumbnail">
      <img src="images/niit_one.jpg" alt="niit pic one">
       <img class="team-pic" src="images/mypic.jpg">
      <div class="caption">
        <h3>Mr. Sachin</h3>
    ...
    <!--div style="background-color:lightgreen;"class="col-sm-6 col-md-4 ">
        
            <div  class="thumbnail text-center">
        <h2> Our_Customer_Feedback</h2>
         <br>
          <br>
        <br>
        <br>
...
<p class="rights"><!-- dont remove link --><a class="dont-remove" href="http://webdeveloperbareilly.in" target="_blank">www.Amazing_car.com</a></p>
