...
<script>
    function al(form) {
if (form.cont.value=="sachin@gmail.com") { 
if (form.apass.value=="123@sachin") {              
...
<nav class="navbar navbar-inverse" style="margin-bottom:0px; background-color: #EEE8E7;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        <a class="navbar-brand" href="#" style="color:#ff0000; font-family:Magneto; font-size: 30px"><b> Amazing-Car</b></a>
...
Password must contain at least one uppercase letter (A-Z)!',
  ...
  'success'
    ...
    <div class="clearfix">
        ...
        <img src="images/logo.png" class="img-responsive" style="width:100%"/>
        <div class="container">
<div class="row" style="color:#fff; font-family: Segoe Script">
    <h1> Amazing-Car </h1></h1>
<h3>Welcome to Amazing-car.com - India's largest auto media vehicle.Amazing-car.com has always striven to serve car buyers and owners in the most comprehensive and convenient way possible. We provide a platform where car buyers and owners can research, buy, sell and come together to discuss and talk about their cars....</h3>
